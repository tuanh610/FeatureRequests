"""
Django settings for FeatureRequests project.
...
SECRET_KEY = '8skk6!fbf-q1i3_m*$$hxcu5c$1s$^%a6gk!45l9y&*^**&#z+'
...
ROOT_URLCONF = 'FeatureRequests.urls'
...
WSGI_APPLICATION = 'FeatureRequests.wsgi.application'
